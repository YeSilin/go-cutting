...
// 小座屏 扣掉两个边框5+5 然后再加回来5厘米  可以理解为扣5
func frame1to1() {
	// 由配置决定是否循环使用此框架
	for {
		...
		// 处理框架生成脚本
		width, height := presenter.FramePresenter1to1(widthStr, heightStr)
...
func frame1to2() {
	...
	for {
		...
		// 处理框架生成脚本
		width, height := presenter.FramePresenter1to2(widthStr, heightStr)
