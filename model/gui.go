...
func logo(w http.ResponseWriter, r *http.Request) {
	// 返回页面
	responseWriter(w, `Config/images/logo7-1.png`)
}
...
func runWebServer() {
	...
	http.HandleFunc("/Config/images/logo7.png", logo) // 设置访问的路由
...
func Gui() {
	...
	// 搭建web窗口
	_ = webview.Open("GoCutting", "http://localhost:9090", 350, 600, true)
}
